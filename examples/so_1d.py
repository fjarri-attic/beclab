...
def runTest(g_ratio, g_strength, lambda_SO, grid_size=2048,
		precision=1e-7, dt_dimensionless=1.0/50, random_init=True):

	so_constants = SOConstants1D(g_ratio=g_ratio, g_strength=g_strength, lambda_SO=lambda_SO)
	...
	box_size = (so_constants.box_size,)
	grid = UniformGrid(constants, (grid_size,), box_size)
